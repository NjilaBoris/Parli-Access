...
const STORIES: Story[] = [
  {
    ...
    category: "Parliament",
    date: "Aug 6, 2026",
    title: "Speaker Datouo Fulfils 40 Million CFAF Healthcare Pledge in Bafoussam",
    href: "/blog/speaker-datouo-healthcare-pledge",
  },
  {
    image: "/img2.jpg",
    category: "Committees",
    date: "Jul 29, 2026",
    title: "Finance Committee Opens Hearings on the 2027 Budget Bill",
    href: "/blog/finance-committee-2027-budget",
  },
  {
    image: "/img3.jpg",
    category: "Legislation",
    date: "Jul 18, 2026",
    title: "National Assembly Adopts Reform to the Electoral Code",
    href: "/blog/electoral-code-reform-adopted",
  },
  {
    image: "/img4.jpg",
    category: "Engagement",
    date: "Jul 4, 2026",
    title: "Women Parliamentarians Network Launches Rural Youth Outreach",
    href: "/blog/women-parliamentarians-youth-outreach",
  },
];
...
export default function PoliticsFeed() {
  return (
    <section className="w-full bg-white px-4 py-10 sm:px-6 sm:py-12 md:px-10 lg:px-12">
      <div className="mx-auto max-w-[88rem]">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 gap-x-5 gap-y-8 xs:grid-cols-2 sm:gap-x-6 lg:grid-cols-4"
        >
          {STORIES.map((story) => (
            <motion.article key={story.href} variants={cardVariant}>
