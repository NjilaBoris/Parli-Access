...
const accentStyles: Record<Accent, string> = {
  ...
  gradient:
    "bg-gradient-to-r from-orange-100/90 to-rose-100/90 ring-1 ring-orange-200",
            ...
            {visibleMembers.map((member) => (
              ...
              >
                <div className="relative aspect-[3/3.4] w-full overflow-hidden rounded-2xl bg-slate-200">
                  ...
                  >
                    <p
                      className={`truncate text-sm font-semibold sm:text-base ${textStyles[member.accent].name}`}
                    >
                      {member.name}
                    </p>
                  </div>
